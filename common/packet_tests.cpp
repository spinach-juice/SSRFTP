...
TEST_CASE("Packet Builders: Shard Request Range")
{
	unsigned long missing_nums[9] = {0x0000, 0x0003, 0x4158, 0x1122, 0x5673, 0xaaaa, 0xf437, 0x0005, 0x0010};

	unsigned long missing_ranges[2] = {0x0020, 0x007a};

	unsigned short num_miss = 9;
	unsigned short num_ranges = 1;

	unsigned short trans_id = 0x5a5a;
	unsigned char valid_output[] = {0x00, 0x03, 0x00, 0x37, 0x05, 0xbe, 0x5a, 0x5a, 0x00, 0x09, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x41, 0x58, 0x00, 0x00, 0x11, 0x22, 0x00, 0x00, 0x56, 0x73, 0x00, 0x00, 0xaa, 0xaa, 0x00, 0x00, 0xf4, 0x37, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x7a};

	Packet p = build_shard_request_range(trans_id, missing_nums, num_miss, missing_ranges, num_ranges);
